        ...
        <div>
            ...
            {modal && <>
                <div className='h-screen w-full fixed top-0 left-0 flex justify-center items-center bg-black bg-opacity-20 '>
                    <div className='relative bg-white rounded shadow-lg w-3/5 h-3/4'>
                        <div className='border-b px-6 py-4 sticky top-0 z-50 flex justify-center'>
                            Modal title
                        </div>

                        <main className='flex-grow overflow-y-scroll  px-6 py-5 '>
                            <div className=''>
                        ...
                        <div className='py-5 border-t absolute   left-0 right-0 bottom-0  z-50 flex justify-between px-6 overflow-hidden'>
                            <button>Clear</button>
